...
import { hidesInfrastructureContainer } from '@/lib/infrastructureGuard';
...
export class ContainersStateManager extends BaseStateManager {
    ...
    async loadInitialState(): Promise<void> {
        ...
        try {
            ...
            for (const container of containers) {
                ...
                if (hidesInfrastructureContainer(state)) continue;
    ...
    private async updateContainerState(containerId: string, action: ContainersStateEvents): Promise<void> {
        ...
        try {
            ...
            if (hidesInfrastructureContainer(newState)) return;
