...
export const GET = route
    ...
    .handler(async (_, { ctx, query }: { ctx: { session: Session }; query: { code?: string; state?: string } }) => {
        ...
        try {
            ...
            try {
                ...
                if (exchangeError instanceof Error && exchangeError.message === GIT_OAUTH_EXCHANGE_FAILED) {
