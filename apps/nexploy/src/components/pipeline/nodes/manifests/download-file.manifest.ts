...
export const downloadFileManifest: NodeManifest = {
    ...
    inputFields: [
        ...
        {
            key: 'outputFile',
            labelKey: 'pipeline.inputs.outputFile',
            descriptionKey: 'pipeline.inputs.desc_outputFile',
            type: 'input',
        },
        {
            key: 'filename',
        ...
        {
            key: 'sizeBytes',
            labelKey: 'pipeline.inputs.sizeBytes',
            descriptionKey: 'pipeline.inputs.desc_sizeBytes',
            type: 'input',
        },
    ],
};
