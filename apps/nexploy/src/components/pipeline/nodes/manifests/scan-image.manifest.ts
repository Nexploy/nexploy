...
export const scanImageManifest: NodeManifest = {
    ...
    inputFields: [
        {
            key: 'image',
            labelKey: 'pipeline.inputs.image',
            descriptionKey: 'pipeline.inputs.desc_image',
            type: 'input',
        },
        { key: 'tag', labelKey: 'pipeline.inputs.tag', descriptionKey: 'pipeline.inputs.desc_tag', type: 'input' },
        {
            key: 'vulnerabilities',
            labelKey: 'pipeline.inputs.vulnerabilities',
            descriptionKey: 'pipeline.inputs.desc_vulnerabilities',
            type: 'input',
        },
        {
            key: 'critical',
            labelKey: 'pipeline.inputs.critical',
            descriptionKey: 'pipeline.inputs.desc_critical',
            type: 'input',
        },
