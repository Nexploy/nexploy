...
export function EnvironmentProtectionCard({ environment, canManage }: EnvironmentProtectionCardProps) {
        ...
        zodResolver(environmentProtectionSchema),
        {
            ...
            actionProps: {
                onSuccess: ({ data }) => {
                    ...
                    toast.success(t('saved', { name: environment.name }));
                },
                onError: ({ error }) => {
    ...
    const applyPreset = (preset: EnvironmentProtectionPreset) => {
        form.setValue('protectedActions', [...environmentProtectionPresets[preset]], { shouldDirty: true });
        form.setValue('isProtected', true, { shouldDirty: true });
    };
                        ...
                        {canManage && (
                            <div className="flex flex-wrap items-center gap-2">
                                ...
                                <Button
                                    ...
                                    onClick={() => form.setValue('protectedActions', [], { shouldDirty: true })}
                                >
                                    {t('clearAll')}
                                </Button>
                            </div>
