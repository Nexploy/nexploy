                    ...
                    <div className="space-y-3">
                        ...
                        {container.args && container.args.length > 0 && (
                            <div className="flex items-start justify-between border-b pb-2">
                                <span className="text-muted-foreground text-sm">{t('args')}</span>
                        ...
                        {container.cmd && container.cmd.length > 0 && (
                            <div className="flex items-start justify-between border-b pb-2">
                                <span className="text-muted-foreground text-sm">{t('cmd')}</span>
                                <code className="bg-muted/50 max-w-md truncate rounded-md px-2 py-1 text-xs">
                                    {container.cmd.join(' ')}
                                </code>
                            </div>
                        ...
                        {container.entrypoint && (
                            <div className="flex items-start justify-between border-b pb-2">
                                <span className="text-muted-foreground text-sm">{t('entrypoint')}</span>
                                <code className="bg-muted/50 max-w-md truncate rounded-md px-2 py-1 text-xs">
