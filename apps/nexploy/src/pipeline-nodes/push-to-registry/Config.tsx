...
import { useNodeEnvironmentId, useNodeImages, useNodeResource } from '@workspace/pipeline-ui/adapter';
...
import type { RegistryInfo } from '@workspace/pipeline-core/registryInfo';
