...
function Button({ className, variant, size, asChild = false, isLoading = false, ...props }) {
    ...
    return _jsxs(Comp, {
        ...
        ...props,
        children: [
            isLoading ? _jsx(Loader2, { className: 'animate-spin' }) : props.icon ? _jsx(props.icon, {}) : null,
            _jsx(Slottable, { children: props.children }),
        ],
    });
}
